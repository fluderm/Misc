...
1. The file IMDB_sentiment.ipynb is a somewhat detailed notebook containing some collections of approaches to sentiment analysis using the IMDB dataset.
  -  We setup a simple baseline and then compare various deep learning and machine learning approaches. The most successful model is a combination of various models achieving test accuracy of ~92%.
